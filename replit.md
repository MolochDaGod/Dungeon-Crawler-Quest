...
- **AI System:** Advanced DOTA2-style AI with game phase awareness (laning 0-3min/midgame 3-10min/lategame 10min+), aggressive hero targeting, last-hitting, gank rotations, focus-fire coordination, orb-walking for ranged heroes, and class-specific ability leveling priorities. Low retreat thresholds (10-25% HP) for sustained combat engagement. Heroes attack enemy minions in all phases rather than idling.
