...
export const ACTION_LABELS: Record<KeybindAction, string> = {
  ...
  [KeybindAction.Ability1]: 'Attack (Q)',
  [KeybindAction.Ability2]: 'Core Skill (E)',
  [KeybindAction.Ability3]: 'Defensive (Space)',
  ...
  [KeybindAction.LevelUpAbility2]: 'Level Up E',
  [KeybindAction.LevelUpAbility3]: 'Level Up Space',
...
export function getDefaultBindings(): KeybindConfig {
  return {
    ...
    [KeybindAction.Ability2]: makeKeyBind('e'),
    [KeybindAction.Ability3]: makeKeyBind(' '),
    ...
    [KeybindAction.LevelUpAbility2]: makeKeyBind('e', false, true),
    [KeybindAction.LevelUpAbility3]: makeKeyBind(' ', false, true),
